...
<img src="https://capsule-render.vercel.app/api?type=waving&height=220&color=gradient&customColorList=0,2,2,5,30&text=Subathran%20J&fontSize=62&fontColor=00f5d4&stroke=0d4f6b&strokeWidth=1&animation=fadeIn&fontAlignY=42&desc=Aspiring%20SOC%20Analyst%20%7C%20Blue%20Team%20%7C%20Cybersecurity%20Student&descSize=18&descAlignY=66&descColor=7dd3fc" alt="Hero Banner" width="100%"/>

<br/>

[![Typing SVG](https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=500&size=18&duration=3200&pause=900&color=00F5D4&center=true&vCenter=true&width=680&lines=Studying+SOC+Operations+%7C+Incident+Response;Building+Home+Labs+with+Splunk+%26+Wazuh;Practising+Log+Analysis+%7C+Alert+Triage;Mapping+Threats+with+MITRE+ATT%26CK;Seeking+SOC+Analyst+L1+%7C+Internship+Roles)](https://git.io/typing-svg)
...
```yaml
Name        : Subathran J
Role Target : SOC Analyst L1  |  Security Analyst  |  Blue Team Intern
Focus Area  : Threat Detection · Incident Response · SIEM Operations · Log Analysis
Location    : India  (open to remote and hybrid)
Status      : Actively seeking internships and entry-level cybersecurity roles
```
...
I am a cybersecurity student with a focused interest in **Security Operations** and **Blue Team** practices. Over the past year, I have been building practical skills through home labs, structured courses, and self-directed learning — studying how SOC analysts detect threats, investigate alerts, and respond to incidents in real enterprise environments.

My learning is hands-on. I build labs using **Splunk**, **Wazuh**, and **Windows Server** to practice what I study: writing detection rules, analysing Windows Event Logs, and tracing attack paths using the **MITRE ATT&CK** framework. I understand that entry-level SOC work is methodical and process-driven, and I'm building habits that reflect that — documentation, repeatability, and attention to detail.

I hold certifications from **Cisco Networking Academy**, **GUVI**, and **Udemy** that have grounded my understanding of network security, endpoint protection, cyber threat management, and information security governance.

**What I bring to a SOC team:**
- Foundational understanding of the SOC alert triage workflow (L1 → escalation)
- Hands-on experience analysing Windows Event Logs and Sysmon data
- Familiarity with SIEM platforms through self-built home labs
- Knowledge of MITRE ATT&CK tactics and techniques applied to lab scenarios
- Strong motivation to learn, document, and improve continuously
...
> **Proficiency scale used:** `Learning` → `Familiar` → `Hands-on Experience`
> Labels reflect honest self-assessment based on labs and coursework, not professional experience.
...
|---|---|---|
| Alert Triage | `Familiar` | Practiced through simulated SOC lab scenarios |
| Log Analysis | `Hands-on Experience` | Windows Event Logs, Sysmon, auth logs in home labs |
| Incident Response | `Familiar` | Studied NIST IR lifecycle; applied in lab exercises |
| Security Monitoring | `Familiar` | SIEM-based monitoring in Splunk and Wazuh labs |
| Threat Detection | `Familiar` | Writing basic detection rules and correlation queries |
...
|---|---|---|
| Splunk | `Learning` | SPL queries, dashboards, basic alert configuration |
| Wazuh | `Learning` | Agent deployment, rule writing, FIM, alert review |
| Microsoft Sentinel | `Learning` | KQL fundamentals, log ingestion concepts |
...
| Skill | Proficiency | Notes |
|---|---|---|
| TCP/IP | `Familiar` | Packet structure, flow analysis, Wireshark capture review |
| DNS / HTTP / HTTPS | `Familiar` | Protocol behaviour and common abuse patterns |
| Network Traffic Analysis | `Familiar` | Wireshark labs for suspicious traffic identification |
| Network Defense Concepts | `Familiar` | Cisco NetAcad Network Defense course |
...
| Tool | Proficiency | Notes |
|---|---|---|
| Wireshark | `Hands-on Experience` | Packet capture analysis in lab environments |
| Nmap | `Familiar` | Host discovery, port scanning, service enumeration |
| Burp Suite | `Learning` | Basic web request interception; exploring HTTP security |
...
|---|---|---|
| Windows (10/Server) | `Hands-on Experience` | Event log analysis, AD lab setup, user activity monitoring |
| Linux (Ubuntu/Debian) | `Familiar` | CLI usage, log file review, basic administration |
| Kali Linux | `Familiar` | Lab environment for security tool exploration |
...
| Skill | Proficiency | Notes |
|---|---|---|
| MITRE ATT&CK | `Familiar` | TTP mapping applied to lab attack scenarios |
| Cyber Kill Chain | `Familiar` | Used as a reference model in lab write-ups |
| IOC Analysis | `Learning` | Identifying and documenting indicators from log data |
| Threat Hunting Concepts | `Learning` | Studying hypothesis-driven hunting methodology |
...
**MITRE ATT&CK Mapping:** T1136 – Create Account · T1098 – Account Manipulation · T1110.001 – Password Guessing
...
**MITRE ATT&CK Mapping:** T1071 – Application Layer Protocol · T1046 – Network Service Discovery
...
**MITRE ATT&CK Mapping:** T1059.001 – PowerShell · T1027 – Obfuscated Files · T1543 – Create or Modify System Process
...
| Blue Team Labs Online — SOC Level 1 | BTL Online | 2025–2026 |
...
| Area | What I'm Studying | Resources |
|---|---|---|
...
| **Microsoft Sentinel** | KQL basics, data connectors, analytic rules | Microsoft Learn, free trial |
| **Threat Hunting** | Hypothesis creation, Sysmon analysis, hunt playbooks | ThreatHunter Playbook, Sigma rules |
| **Incident Response** | NIST SP 800-61 lifecycle, containment decisions, IR reporting | NIST documentation, labs |
| **Active Directory** | Authentication event IDs, Kerberoasting detection, AD hardening | Home lab, IppSec, TCM Security |
...
**I'm actively looking for SOC Analyst internships, entry-level Security Analyst roles, and Blue Team opportunities.**
**If you're a recruiter or hiring manager in cybersecurity, I'd love to connect.**
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=0,2,2,5,30&height=110&section=footer&text=Building+skills+one+lab+at+a+time+%E2%80%94+committed+to+growing+into+a+capable+SOC+Analyst.&fontSize=13&fontColor=00f5d4&fontAlignY=62&animation=fadeIn" width="100%"/>
